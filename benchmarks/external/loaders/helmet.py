...
LICENSE = 'MIT'
LICENSE_NOTE = 'Verified 2026-07-29 against github.com/princeton-nlp/HELMET (MIT). HELMET composes upstream datasets that carry their own terms; check the per-task sources before redistributing derived data.'
