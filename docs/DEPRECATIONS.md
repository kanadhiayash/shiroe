...
| `LEGACY_LINEAGE_INTAKE_CSV_NAME` | `SHIROE_64_repo_lineage_intake.csv` | `DeprecationWarning`: "…is deprecated; rename it to SHIROE_64_repo_lineage_intake.csv" | kanadhiayash | 4.0.0 | `MIGRATION.md` §Lineage intake CSV — rename your local copy | `tests/test_legacy_compatibility_boundary.py::test_pre_rename_lineage_csv_filename_is_still_found` |
| `LEGACY_LINEAGE_COLUMN_ALIASES` | `shiroe_adoption`, `why_it_matters_to_shiroe` | `DeprecationWarning`: "intake column … is deprecated; rename it to …" | kanadhiayash | 4.0.0 | `MIGRATION.md` §Lineage intake CSV — rename the two headers | `tests/test_lineage_intake.py::test_pre_rename_column_headers_still_load` |
