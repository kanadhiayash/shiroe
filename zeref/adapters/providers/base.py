...
``zeref.provider/v1`` (legacy, still loadable)
    .. code-block:: json
...
Fail-closed rule (ZRF-60): a model resolves on a **live** call only if its
...
PROVIDER_SCHEMA_V1 = "zeref.provider/v1"
PROVIDER_SCHEMA_V2 = "zeref.provider/v2"
...
class ModelCapability:
    """Verification + limits record for one concrete model (ZRF-60).
