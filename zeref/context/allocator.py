"""Token-budget allocator around the six-section context packet (ZRF-64).
...
from zeref.adapters.providers import DEFAULT_PROVIDER, get_provider
from zeref.adapters.providers.base import ModelCapability
