"""Installed-state manifest (ZRF-67).
...
is really installed (via ``zeref doctor --installation`` / ``zeref version
...
_EXCLUDED_DIRS = {
    ...
    ".pytest_cache", ".zeref-sandbox", "memory", ".claude",
}
...
def build_manifest(root: Path) -> InstalledManifest:
    from zeref import __version__ as version
    ...
    return InstalledManifest(
        ...
        registry_digest=_sha256_file(root / "zeref-registry.json"),
